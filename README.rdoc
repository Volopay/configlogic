...
== Project Moved: This project has been moved to https://github.com/Configlogic/Configlogic

Configlogic is a simple configuration / settings solution that uses an ERB enabled YAML file. It has been great for
our apps, maybe you will enjoy it too.  Configlogic works with Rails, Sinatra, or any Ruby project.

{<img src="https://badge.fury.io/rb/Configlogic.svg" alt="Gem Version" />}[http://badge.fury.io/rb/Configlogic]
{<img src="https://travis-ci.org/Configlogic/Configlogic.svg" alt="Build Status" />}[https://travis-ci.org/Configlogic/Configlogic]
{<img src="http://inch-ci.org/github/Configlogic/Configlogic.png?branch=master" alt="Inline docs" />}[http://inch-ci.org/github/Configlogic/Configlogic]

== Helpful links

* <b>Documentation:</b> http://rdoc.info/projects/binarylogic/Configlogic
* <b>Repository:</b> http://github.com/binarylogic/Configlogic/tree/master
* <b>Issues:</b> http://github.com/binarylogic/Configlogic/issues

== Installation

  gem install Configlogic
...
This can cause collisions with Configlogic, since those methods are global. Luckily, the
